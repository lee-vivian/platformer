...
if __name__ == "__main__":
    # mario_prolog_file = 'level_saved_files_block/prolog_files/mario-1-1.pl'
    # main(mario_prolog_file, level_w=202, level_h=14, min_perc_blocks=15, level_sections=4, max_sol=25,
    #      print_level_stats=False, save=True, validate=True)
    #
    # main(mario_prolog_file, level_w=50, level_h=14, min_perc_blocks=15, level_sections=4, max_sol=100,
    #      print_level_stats=False, save=True, validate=True)
    #
    # exit(0)
