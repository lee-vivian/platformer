...
def main(prolog_file, level_w, level_h, min_perc_blocks, min_num_bonus_tiles, level_sections, max_sol,
    ...
    if min_num_bonus_tiles > 0 and prolog_file_info.get('bonus_tile_id') is None:
    ...
    solver = Solver(prolog_file=prolog_file, level_w=level_w, level_h=level_h,
                    min_perc_blocks=min_perc_blocks, min_num_bonus_tiles=min_num_bonus_tiles,
...
if __name__ == "__main__":
    ...
    parser.add_argument('--min_num_bonus_tiles', type=int, default=0, help='Minimum number of bonus tiles in a level')
    ...
    main(args.prolog_file, args.level_w, args.level_h, args.min_perc_blocks, args.min_num_bonus_tiles,
